...
| Reflector rotor machines (Enigma family) | invariant, no search | Impossible: C[i] == P[i] at positions 32 and 73. EXP-007. |
| Playfair | invariant, both digraph alignments | Impossible: cannot emit a doubled letter, yet ST->SS, NO->QQ, IN->TT. EXP-007. |
